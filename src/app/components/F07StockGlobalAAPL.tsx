...
export function F07StockGlobalAAPL() {
          ...
          <>
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                ...
                <div className="w-full bg-[#F5F5F5] rounded-full h-2">
                  <div className="bg-[#888888] h-2 rounded-full" style={{ width: "52%" }} />
                </div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-[16px] text-[#1A1A1A] mb-2" style={{ fontWeight: 700 }}>긍정 61%</div>
                <div className="w-full bg-[#F5F5F5] rounded-full h-2">
                  <div className="bg-[#1565C0] h-2 rounded-full" style={{ width: "61%" }} />
                </div>
              </div>
            </div>
            <div className="bg-[#FFFBF0] p-4 rounded-lg mb-3">
              ...
              <div className="text-[14px] text-[#1A1A1A] leading-relaxed">
                폴더블 아이폰 출시 지연 우려 단기 부담. 4월 30일 실적 발표 대기, 서비스 부문 성장 주목.
              </div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3">
              ...
              <div className="space-y-3">
                {[
                  { name: "기술적 분석", status: "중립", color: "#888888" },
                  { name: "수급 분석", status: "긍정", color: "#4CAF50" },
                  { name: "뉴스 감성", status: "주의", color: "#F44336" },
          ...
          <>
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3">
              ...
              <div className="w-full h-8 flex rounded-lg overflow-hidden mb-2">
                <div className="bg-[#1565C0]" style={{ width: "61%" }} />
                <div className="bg-[#888888]" style={{ width: "25%" }} />
                <div className="bg-[#F44336]" style={{ width: "14%" }} />
              </div>
              <div className="flex justify-between text-[12px]">
                <div className="text-[#1565C0]">긍정 61%</div>
                <div className="text-[#888888]">중립 25%</div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3">
              ...
              <div className="flex flex-wrap gap-2">
                {["#폴더블아이폰", "#서비스매출", "#AI인텔리전스", "#실적발표"].map((keyword) => (
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3">
              ...
              <div className="space-y-3">
                {[
                  { icon: "👍", text: "1분기 매출 $1,438억, EPS $2.84 예상 상회" },
                  { icon: "👍", text: "Services 부문 $300억, YoY +14% 성장 지속" },
                  { icon: "👎", text: "폴더블 아이폰 출시 지연 가능성 단기 리스크" },
                ].map((opinion, i) => (
          ...
          <>
            ...
            <div className="bg-[#F0F4FF] p-4 rounded-lg shadow-sm mb-3">
              ...
              <div className="space-y-2">
                {[
                  "1분기 EPS $2.84, 예상치 $2.67 상회 (6.23% 서프라이즈)",
                  "iPhone 매출 $853억, YoY +23% 성장",
                  "영업현금흐름 $539억 사상 최대 기록",
                  "인도·중국 신흥시장 사상 최대 매출 달성",
                ].map((item, i) => (
          ...
          <>
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3">
              ...
              <table className="w-full text-[12px]">
                ...
                <tbody>
                  {[
                    ["매출(B)", "383.3", "391.0", "438.3"],
                    ["영업이익(B)", "114.3", "123.2", "143.8"],
                    ["순이익(B)", "97.0", "101.0", "124.3"],
                    ["영업이익률", "29.8%", "31.5%", "32.8%"],
                  ].map((row, i) => (
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-3" ref={tooltipRef}>
              ...
              <table className="w-full text-[12px]">
                ...
                <tbody>
                  {[
                    ["PER", "28.4x", "32.1x", "적정", "#888888", "주가수익비율. 낮을수록 저평가. 업종 평균보다 낮으면 매수 고려."],
                    ["PBR", "45.2x", "18.2x", "고평가", "#1565C0", "주가순자산비율. 1배 이하면 자산 대비 저평가 상태."],
                    ["ROE", "147.9%", "42.3%", "우수", "#D32F2F", "자기자본이익률. 높을수록 기업이 돈을 잘 버는 것."],
                    ["부채비율", "198.3%", "85.0%", "주의", "#1565C0", "총부채/자기자본. 낮을수록 재무 안정성이 높음."],
                    ["배당수익률", "0.55%", "0.80%", "보통", "#888888", "주가 대비 배당금 비율. 높을수록 배당 매력 있음."],
                  ].map((row, i) => (
      ...
      <div className="bg-white px-4 py-3 border-b border-[#E0E0E0]">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-[16px] text-[#1A1A1A]" style={{ fontWeight: 700 }}>
            Apple Inc. <span className="text-[#888888]">AAPL · NASDAQ</span>
          </div>
          <div className="w-6" />
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-baseline gap-2">
            <div className="text-[24px] text-[#1A1A1A]" style={{ fontWeight: 700 }}>$273.43</div>
            <div className="text-[14px] text-[#1565C0]">▼ -2.37 (-0.86%)</div>
          </div>
      ...
      <div className="bg-white px-4 flex gap-6 border-b border-[#E0E0E0] overflow-x-auto">
        {["종합", "여론", "AI분석", "재무"].map((tab) => (
          <button
            ...
            className={`py-3 text-[14px] whitespace-nowrap ${activeTab === tab ? "text-[#1A1A1A] border-b-2 border-[#FF6600]" : "text-[#888888]"}`}
          >
            {tab}
          </button>
        ))}
