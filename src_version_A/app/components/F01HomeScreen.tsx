    ...
    <div className="w-full h-full bg-[#F5F5F5] flex flex-col">
      ...
      <div className="bg-white px-4 py-3 flex items-center justify-between border-b border-[#E0E0E0]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onSimpleToggle} className="text-[11px] text-[#888888] underline">심플 모드</button>
        </div>
      </div>
      ...
      <div className="bg-white px-4 flex gap-6 border-b border-[#E0E0E0] overflow-x-auto">
        ...
        <button className="py-3 text-[14px] text-[#888888] whitespace-nowrap">인사이트</button>
        <button className="py-3 text-[14px] text-[#888888] whitespace-nowrap">자산</button>
        <button className="py-3 text-[14px] text-[#888888] whitespace-nowrap">MY</button>
      </div>
