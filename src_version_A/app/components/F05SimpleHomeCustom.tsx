...
interface F05SimpleHomeCustomProps {
  onSimpleToggle: () => void;
}

export function F05SimpleHomeCustom({ onSimpleToggle }: F05SimpleHomeCustomProps) {
  ...
  return (
    <div className="w-full h-full bg-[#F5F5F5] flex flex-col relative">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Section 2: 최근 본 종목 - moved to top */}
