...
interface F03GlobalSimpleProps {
  onSimpleToggle: () => void;
}

export function F03GlobalSimple({ onSimpleToggle }: F03GlobalSimpleProps) {
    ...
    <div className="w-full h-full bg-[#F5F5F5] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-4 bg-white mb-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white border border-[#E0E0E0] p-4">
              <div className="text-[14px] text-[#888888] mb-2">NASDAQ</div>
              <div className="text-[18px] text-[#1A1A1A] mb-1" style={{ fontWeight: 700 }}>19,146.81</div>
              <div className="text-[14px] text-[#1565C0]">▼ -0.89%</div>
            </div>
            <div className="bg-white border border-[#E0E0E0] p-4">
              <div className="text-[14px] text-[#888888] mb-2">S&P500</div>
              <div className="text-[18px] text-[#1A1A1A] mb-1" style={{ fontWeight: 700 }}>5,348.82</div>
              <div className="text-[14px] text-[#1565C0]">▼ -0.41%</div>
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-3 overflow-x-auto">
            {[
              ...
              <button
                ...
                className="bg-white border border-[#E0E0E0] p-4 min-w-[140px]"
              >
        ...
        <div className="p-4 bg-white mb-3">
          ...
          <div className="bg-white border border-[#E0E0E0] p-5 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <div className="text-[16px] text-[#1A1A1A]" style={{ fontWeight: 700 }}>AI 반도체</div>
              <div className="text-[16px] text-[#D32F2F]" style={{ fontWeight: 700 }}>▲ +5.2%</div>
            </div>
            <div className="text-[13px] text-[#888888]">TSMC 사상 최고가 경신</div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between py-2 border-b border-[#F5F5F5]">
                ...
                <div className="text-[14px] text-[#888888]">{stock.volume}</div>
              </div>
            ))}
          </div>
        </div>
