          ...
          <div className="bg-white rounded-2xl p-6 w-[300px] shadow-2xl">
            ...
            <div className="mb-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-[#E5E5E5] rounded-lg text-[13px] pr-20 focus:border-[#FF6600] focus:outline-none placeholder:text-[#BBBBBB]"
                />
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-[#E5E5E5] rounded-lg text-[13px] focus:border-[#FF6600] focus:outline-none"
              />
            </div>
